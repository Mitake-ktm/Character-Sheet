  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back Face */}
        <div className="absolute w-full h-full bg-purple-100 dark:bg-neutral-900 rounded-2xl shadow-xl p-4 rotate-y-180 backface-hidden flex flex-col justify-center">
